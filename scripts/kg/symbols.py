...
class PythonAstExtractor(BaseExtractor):
    ...
    # nebula-insurance-brain: Python is the first-class backend and AI language
    # (engine/ and neuron/ per planning-mds/BLUEPRINT.md section 2.3), so the
    # sidecar walk covers both runtime roots. Framework default is [].
    compilation_roots: list[str] = ["engine", "neuron"]
