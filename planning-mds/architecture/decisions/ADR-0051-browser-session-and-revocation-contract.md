# ADR-0051: Browser Session and Revocation Contract
...
Proposed: Prefer same-origin BFF with server-held tokens; resolve SPA/cookie design drift before implementation.
