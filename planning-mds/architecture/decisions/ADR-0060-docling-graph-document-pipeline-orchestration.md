...
Evidence and reviewer verdicts belong in [F0005 STATUS](../../features/F0005-one-time-docling-ingestion/STATUS.md). The pin, native/scanned conversion, publication ordering, and native-JSON branch have partial evidence. No complete gate is satisfied; live model, evidence mapping, durable recovery, and operational qualification remain pending. Structural planning checks cannot change this ADR to Accepted.
