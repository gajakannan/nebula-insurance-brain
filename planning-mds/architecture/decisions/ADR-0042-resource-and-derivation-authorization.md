# ADR-0042: Resource and Derivation Authorization
...
Proposed in the master blueprint pre-build requirements to settle: Enforce current grants across facts, evidence, reviews, derived results, and caches.

Example and reference: Restricted note cannot leak via summary; section 110.

## Decision

Pending. The decision to settle is: Enforce current grants across facts, evidence, reviews, derived results, and caches.
