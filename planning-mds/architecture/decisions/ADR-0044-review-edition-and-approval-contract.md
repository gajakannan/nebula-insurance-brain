# ADR-0044: Review Edition and Approval Contract
...
Proposed in the master blueprint pre-build requirements to settle: Selected Label Studio edition; annotation separate from canonical approval.

Example and reference: Stale reviewer correction; section 111.

## Decision

Pending. The decision to settle is: Selected Label Studio edition; annotation separate from canonical approval.
