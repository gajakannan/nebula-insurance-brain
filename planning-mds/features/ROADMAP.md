...
| [F0005 — One-time document ingestion](./F0005-one-time-docling-ingestion/README.md) | Planned | Durable document ingestion with a proposed Docling-Graph pipeline. Candidate 1.9.1 adapter and contract tests; complete reuse, evidence, recovery, and operational qualification pending. | F0004 artifact contract; F0001 historical baseline. Before activation, prove the pinned ADR-0060 integration, pre-extraction checkpoint, native/scanned reuse, evidence translation, and recovery. |
