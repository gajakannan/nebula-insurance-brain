# Coverage Report — F0001-repository-and-engineering-foundation run 2026-09-12-855d2b93
...
The new credential-failure logging contract is directly exercised by the deterministic
security test that passed in this run. The five Postgres-backed HTTP tests are retained
and explicitly reported as skipped when the runtime boundary is unavailable; they are
