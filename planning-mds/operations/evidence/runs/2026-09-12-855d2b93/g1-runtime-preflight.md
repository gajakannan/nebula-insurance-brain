# G1 — Runtime Preflight — F0001 run 2026-09-12-855d2b93
...
`docker compose ps` confirmed `brain-postgres` and both Authentik services healthy. The
managed test sandbox cannot connect to the published Postgres port; the QE fixture now
uses bounded socket/connect timeouts and records those cases as skipped rather than
hanging. No deployment configuration changed in this remediation.
